...
function Login() {
    ...
    //Iniciar sesion y comprobar que el usuario este registrado en la base de datos
    async function handleSubmit(e: any) {
        e.preventDefault();
        setAlertOpen(true);

        fetch(`http://localhost:3030/login?user=${data.username}&password=${data.password}`)
